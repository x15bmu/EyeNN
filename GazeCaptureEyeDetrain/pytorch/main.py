...
workers = 8
epochs = 30#100
batch_size = 100 #torch.cuda.device_count()*100 # Change if out of cuda memory

base_lr = 0.0000000001#0.0001
momentum = 0.9
weight_decay = 1e-4
print_freq = 10
prec1 = 0
...
def main():
    ...
    optimizer = torch.optim.SGD(model.eyeModel.parameters(), lr,
                                momentum=momentum,
